...
router
  .post("/post-budget", auth(config.auth_level.user), uploadFile(), WalletController.postBudget)
  .get("/get-budget", auth(config.auth_level.user), WalletController.getBudget)
  .get("/get-my-budget", auth(config.auth_level.user), WalletController.getMyBudget)
  .get("/get-all-budget", auth(config.auth_level.admin), WalletController.getAllBudget)
  .patch("/update-budget", auth(config.auth_level.user), WalletController.updateBudget)
  .delete("/delete-budget", auth(config.auth_level.user), WalletController.deleteBudget)
