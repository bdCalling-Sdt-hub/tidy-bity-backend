const signUpEmailTemp = (data) => `
  <html>
    ...
    <body>
      <div class="container">
        <h1>Welcome to Tidy Bity</h1>
        <p>Hello, ${data.user}</p>
        <p>Thank you for registering with Tidy Bity. To activate your account, please use the following activation code:</p>
        ...
        <p>Thank you,<br>The Tidy Bity Team</p>
      </div>
      <div class="footer">
